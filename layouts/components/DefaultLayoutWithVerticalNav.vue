...
// Liste des chemins pour lesquels le VerticalNavLayout ne doit pas être affiché
const hideVerticalNav = ['/visiteur']
</script>
...
<template>
  ...
  <!-- Afficher le contenu directement lorsque VerticalNavLayout est masqué -->
  <div v-else>
    <slot />
  </div>
</div>
